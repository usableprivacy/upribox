...
def create_argparser():
    ...
    # create the parser for the "set_tor_ssid" command
    parser_set_tor_ssid = subparser.add_parser('set_tor_ssid',
                                               help='Sets a new SSID for the Ninja WiFi by writing to the fact *wlan*')
    parser_set_tor_ssid.add_argument('arg', help='The SSID for the Silent WiFi', metavar="ssid")

    # create the parser for the "set_tor_password" command
    parser_set_tor_password = subparser.add_parser('set_tor_password',
                                                   help='Sets a new password for the Ninja WiFi by writing to the fact *wlan*')
    parser_set_tor_password.add_argument('arg', help='The SSID for the Silent WiFi', metavar="password")
    ...
    # create the parser for the "enable_tor" command
    parser_enable_tor = subparser.add_parser('enable_tor',
                                             help='Enables/disables the Ninja WiFi by writing to the fact *tor*')
    parser_enable_tor.add_argument('arg', help='Whether or not Ninja WiFi is enabled ("yes" or "no")',
    ...
    # create the parser for the "restart_tor" command
    subparser.add_parser('restart_tor', help='Triggers the Ansible tasks with the tag *toggle_tor*')
